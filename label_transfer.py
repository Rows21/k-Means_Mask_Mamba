...
from dataset.dataloader import KMData
from dataset.dataloader_tts import LoadImaged_totoalseg
from monai.data import DataLoader, list_data_collate, DistributedSampler
...
TEMPLATE={
    ...
    '10_09': [1],
    '10_10': [31],
    '15_2': [1,2,3,4,6,7,8,9,10,11,12,13,16,16,17,17,17],
