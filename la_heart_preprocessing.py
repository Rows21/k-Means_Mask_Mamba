...
def covert_h5():
    listt = glob('/mnt/3DUXNET/3DUX-Net/datasets/LA2018/Training Set/*/lgemri.nrrd')
...
if __name__ == '__main__':
    #h5f = h5py.File("/mnt/3DUXNET/3DUX-Net/datasets/LA2018/Training Set/5FKQL4K14KCB72Y8YMC2/mri_norm2.h5", 'r')
    covert_h5()
